...
//         var correctSort = Data.Products
//             .OrderBy(p => p.Category)
//             .ThenByDescending(p => p.Price);

//         Console.WriteLine("1. Category ASC + Price DESC:");

//         Print(correctSort);

        

//         var bugSort = Data.Products
//             .OrderBy(p => p.Category)
//             .OrderBy(p => p.Price);
...
//         var threeKeySort = Data.Products
//             .OrderByDescending(p => p.InStock)
//             .ThenBy(p => p.Category)
//             .ThenBy(p => p.Name);

//         Console.WriteLine(
//             "\n4. InStock DESC + Category ASC + Name ASC:");
