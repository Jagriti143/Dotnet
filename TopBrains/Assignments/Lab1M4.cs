...
//         var methodSyntax = Data.Products
...
//         // (c) Query syntax for where + method syntax OrderBy
//         var mixedOne =
//             (from p in Data.Products
//              where p.Price < 1000
//              select p)
...
//         var mixedTwo =
//             from p in Data.Products.Where(p => p.Price < 1000)
//             orderby p.Name
//             select p;
...
//             methodSyntax.SequenceEqual(mixedOne) &&
//             methodSyntax.SequenceEqual(mixedTwo);

//         Console.WriteLine("\nAll four results identical: " + allMatch);
//     }
