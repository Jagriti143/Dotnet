...
//         }
//     }
//     private void InsertNotFull(BTreeNode nide,int Key)
//     {
//         int i=XmlNode.Keys.Count-1;
//         if (XmlNode.IsLeaf)
//         {
//             node.Keys
//         }
...
//         BTreeNode child=parent.Children[index];
//         BTreeNode newChild=new BTreeNode(child.IsLeaf);
//         //copy the last minKeys to newChild 
//         for(int j = 0; j < minKeys; j++)
//         {
//             newChild.Keys.Add(child.Keys[j + degree]);
//         }
...
//         for(int j=maxKeys -1;j>=degree -1; j--)
//         {
//             child.Keys.RemoveAt(j);
//         }
//         if (!child.IsLeaf)
//         {
//             for(int j = degree - 1; j < child.Children.Count; j++)
//             {
//                 child.Children.RemoveAt(j);
//             }
...
//             //Remove the middle key from child
//             child.
//         }
//     }
// }